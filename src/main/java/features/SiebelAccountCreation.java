...
public  class SiebelAccountCreation
{
            ...
            if(Execution_Status.equalsIgnoreCase("Yes"))
            {
                ...
                try{
                    ...
                    if(FunctionLibrary.verifyWebElementExist(homePageVerificationTxt,Desc))
                    {
                        ...
                        FunctionLibrary.setText("xpath=.//input[@aria-labelledby='VehicleCount_Label']", eachTestCaseData.get("Challenge Question"), Desc);
                        ...
                        if(eachTestCaseData.get("Email Address").length()>1)
                        {
                            try{
                        ...
                        FunctionLibrary.Wait_For_Object.until(ExpectedConditions.elementToBeClickable(By.xpath
                                (".//*[@aria-labelledby='VAT_registration_number_Label']")));
                        ...
                        if(eachTestCaseData.get("Is Anonymous").equalsIgnoreCase("YES")){
                            FunctionLibrary.clickObject("xpath=//*[@aria-label='Is Anonymous']//following::span[2]", "","Clicking on Anonymous checkbox");
                            ReportLibrary.Add_Step(ReportLibrary.Test_Step_Number, "Select Anonymous checkbox", LogStatus.INFO, false);
                        ...
                        if(TaxExempt.equalsIgnoreCase("YES")){
                            FunctionLibrary.clickObject("xpath=//*[@aria-label='Tax Exempt']//following::span[2]", "","Clicking on Tax Exepmt checkbox");
                            ...
                            ReportLibrary.Add_Step(ReportLibrary.Test_Step_Number, "Select Tax Exepmt checkbox", LogStatus.INFO, false);
                                            ...
                                            if(planName.equalsIgnoreCase("GOVPOST")){
                                                ...
                                                Desc="Click on Govt Agency Text Field";
                                                                /*           FunctionLibrary.highLightElement(FunctionLibrary.ObjDriver,
                                                                                                                FunctionLibrary.ObjDriver.findElement(By.xpath("//*[contains(@aria-labelledby, 'Is_Government_Agency')]")));
                                                                                FunctionLibrary.clickObject("xpath=//*[contains(@aria-labelledby, 'Is_Government_Agency')]", "", Desc);
                                                ...
                                                FunctionLibrary.clickObject("xpath=//*[contains(@aria-labelledby, 'Is_Government_Agency')]", "", Desc);
                                                       ...
                                                       /* Desc="Enter Text into Govt Agency Field";
                                                        FunctionLibrary.setText("xpath=//input[contains(@aria-labelledby, 'Is_Government_Agency')]", "POLICE", Desc);
                                                        Thread.sleep(2000);*/
                        ...
                        {
                            ReportLibrary.Add_Step(ReportLibrary.Test_Step_Number, "Unexpected alert is showing up. Alert text is :"+
                        ...
                        if (FunctionLibrary.ObjDriver.findElement(By.xpath("//input[@aria-label='Acct #']")).isDisplayed())
                        {
                            ...
                            //Scroll down to new button
                            Desc="Scroll dwon to New button";
                            FunctionLibrary.ScrollUptoElement("xpath=//input[@aria-label='Acct #']", Desc);
                            ...
                            ExcelSheet.writeExcel("TestData_siebel", "siebel", iterator, 42, +AccountNumber++, true);
    ...
    private static void logoutSiebelApplicaiton() {
